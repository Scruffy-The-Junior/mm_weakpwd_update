...
# Create the header for the report file
echo "Password was successfully autogenerated for the following users:" > mm_pwgen_report.txt
echo "================================================================" >> mm_pwgen_report.txt
echo "" >> mm_pwgen_report.txt

# Nested loop: read email address from a file, generate the random password and pass those two arguments to the command
